...
var Formatter = /** @class */ (function () {
    ...
    Formatter.prototype.transactionResponse = function (transaction) {
        ...
        // response
        // 处理ux
        if (transaction.hash && transaction.hash[0] == 'u' && transaction.hash[1] == 'x') {
            transaction.hash = '0' + transaction.hash.slice(1);
        }
        if (transaction.from && transaction.from[0] == 'u' && transaction.from[1] == 'x') {
            transaction.from = '0' + transaction.from.slice(1);
        }
        if (transaction.to && transaction.to[0] == 'u' && transaction.to[1] == 'x') {
            transaction.to = '0' + transaction.to.slice(1);
        }
