...
export function supportChangeBalances(Assertion) {
    Assertion.addMethod('changeBalances', function (wallets, balanceChanges) {
        ...
        const derivedPromise = getBalanceChanges(subject, wallets)
            ...
            this.assert(actualChanges.every((change, ind) => change.eq(utils.bigNumberify(balanceChanges[ind]))), `Expected ${walletsAddresses} to change balance by ${balanceChanges} wei, ` +
